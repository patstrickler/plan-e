...
import { Project, MilestonePriority } from '@/types';
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 mb-1">
                    {milestoneStakeholders.map((stakeholder, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-md text-xs"
                      >
                        {stakeholder}
                        <button
                          type="button"
                  ...
                  <div className="flex gap-1">
                    <input
                      ...
                      className="flex-1 px-2 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm"
                      placeholder="Add stakeholder"
                    />
                    <button
                      type="button"
                      onClick={handleAddStakeholder}
                      className="px-2 py-1 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 text-sm"
                    >
                      Add
                    </button>
                  </div>
